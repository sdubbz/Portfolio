...
export const HomeAbout = () => {
  ...
  return(
    ...
    <div class="flex border-solid hover:scale-150 border-4 homeAbout mx-auto items-center justify-evenly grow-[3]">
    <img class="scott" src="/images/scott.jpeg"></img>
    <p class="text-xl" >
...
//   <div>
//   <h3 class="absolute bottom-0 right-0 ... ">Hello my name is Scott Wilson, welcome to my  portfolio website. If you havn't guessed yet, I was a carreer bartender before transition so software engineering. Take a look around at my projects section, or learn more about me in the Scott'sTales section, maybe grab a cocktail while your at it</h3>
// </div>
  )
}
